        ...
        <div class="row justify-content-lg-between align-items-center">
            <div class="col-xxl-5 col-xl-6 col-lg-7">
                <div class="title-area">
                    <span class="sub-title">Новости</span>
                    <h2 class="sec-title text-theme">Новости аренды </h2>
                    <p class="sec-text text-theme">в ТЦ Нижнего Новгорода</p>
                </div>
            </div>
            <div class="col-auto">
                <div class="sec-btn">
                    <a href="blog.php" class="th-btn style2 th-btn-icon">Все новости</a>
                </div>
            </div>
        </div>
